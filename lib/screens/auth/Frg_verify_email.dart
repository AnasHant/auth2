...
class FrgVerifyEmailPage extends StatefulWidget {
  @override
  _FrgVerfEmailState createState() => _FrgVerfEmailState();
}

class _FrgVerfEmailState extends State<FrgVerifyEmailPage> {
  late Timer _timer;
  int _start = 60;
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Please enter the verification code we have sent to you by Email:',
